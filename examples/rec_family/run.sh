...
zsh examples/rec_family/G3.sh $sync_interval $sync_offset $project_name $total_steps $save_interval $eval_interval $random_seed $prefix $CONFIG_FILE $runner_num_train $engine_num_train $runner_num_bench $engine_num_bench